	...
	implements Command
{
	 ...
	 * The field index is passed in option {@code field} starting at 1,
	 * the value is got from option {@code value}.
     * The first line will be returned anyway if the option {@code header} is {@code true}.
	 */

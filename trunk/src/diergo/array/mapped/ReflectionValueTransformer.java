 ...
 * objects.
 */
public class ReflectionValueTransformer<T>
        implements ValueTransformer<T>
{
    private static final Collection<String> FORBIDDEN_METHODS = Arrays.asList(new String[] { "getClass", "hashCode",
            "equals" });
     ...
     * are set ot an object when a constructor with a single string argument is
     * found.
     */

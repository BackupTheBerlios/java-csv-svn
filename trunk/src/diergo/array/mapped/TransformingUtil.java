...
{
	public static <T,E> Iterator<T> wrapMap(final Iterator<Map<String,E>> iterator, final ValueTransformer<T,E> transformer)
	{
	...
	public static <T,E> Iterator<Map<String,E>> wrapValue(final Iterator<T> iterator, final ValueTransformer<T,E> transformer)
	{

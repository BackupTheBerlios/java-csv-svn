...
public class MappedArrayIteratorTest
{
    ...
    {
        Iterator<Map<String, Integer>> iterator = new MappedArrayIterator<Integer>(new String[0], Arrays.asList(
                new Integer[0][]).iterator());
    ...
    {
        Iterator<Map<String, String>> iterator = MappedArrayIterator.createWithHeaders(Arrays.asList(
    ...
    {
        Map<String, Integer> result = new MappedArrayIterator<Integer>(new String[] { "h1", "h2" }, Arrays.asList(
                new Integer[][] { { new Integer(1), new Integer(2) } }).iterator()).next();
    ...
    {
        Map<String, Integer> result = new MappedArrayIterator<Integer>(new String[] { "h1", "h2" }, Arrays.asList(
                new Integer[][] { { new Integer(1) } }).iterator()).next();
        assertEquals(1, result.get("h1").intValue());

...
/**
 * This value transformer creates proxies using reflection to get values.
 * Public getters are supported for primitive types, strings and other
 * objects.
 */
public class ReflectionProxyTransformer<T> extends ReflectionValueTransformer<T> {
  ...
  private class DataGetter implements InvocationHandler {

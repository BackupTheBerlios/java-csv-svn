        ...
        implements Comparator<E[]>
{
    ...
    /**
     * Compares the two arrays. If both arrays contain a field at an index
     * specified by the field order passed to the constructor, the comparision
     * will be delegated to {@link #compare(Comparable, Comparable, int)}.
     */
